...
class CheckSuite(unittest.TestCase):
    ...
    def test_no_entry_point_use_ast(self):
        ...
        FuncDecl(Id("hello"),[],IntType(),Block([Return(IntLiteral(1))]))])
    ...
    def test_redeclare_function_use_ast(self):
        input = Program([
            ...
            FuncDecl(Id("main"),[],VoidType(),Block([CallExpr(Id("hello"),[IntLiteral(1)])]))])
    ...
    def test_not_left_value_invalid_with_arraycell_use_ast(self):
        ...
        expect = "Not Left Value: BinaryOp(+,ArrayCell(Id(arr),Id(b)),IntLiteral(1))"
    ...
    def test_variable_hide_func_with_many_block_nested_use_ast(self):
        ...
        """
        expect = "Type Mismatch In Expression: CallExpr(Id(gt),[])"
    ...
    def test_not_left_value_valid_with_many_block_1(self):
        input = """
            int[] main(int a[]){
                return a;
            }
